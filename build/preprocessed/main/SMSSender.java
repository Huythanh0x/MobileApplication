...
/*     */   public int[] uc_number;
/*     */   public boolean success;
/*     */   
/*     */   public SMSSender(GameRun gr_) {
/* 201 */     this.sms = new StringBuffer(); this.address = new StringBuffer();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 409 */     this.sms_a = true; this.sms_b = false;
/*     */ 
/*     */     
/* 412 */     this.menu = new byte[][] { { 0, 1, 2, 3, 4, 5 }, { 6 }, { 7 }, { 8 } }; this.sel = new byte[2]; this.sendSms = -1; this.smsCount = new byte[][] { { 1, 1, 1 }, { 1, 1, 2 }, { 1, 1, 3 }, { 1, 1, 4 }, { 1, 1, 5 }, { 1, 1, 0 }, { 1, 1, 6 }, { 1, 1, 5 } };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 896 */     this.uc_text = new String[][] { { "购买30000金,仅需4元。", "74", "161", "01", "01" }, { "购买5000金 ，仅需2元。", "74", "161", "02", "01" }, { "购买50徽章，仅需4元。", "74", "161", "03", "01" }, { "购买10徽章,仅需2元。", "74", "161", "04", "01" }, { "宠物升级，仅需2元。", "74", "161", "05", "01" }, { "购买奇异兽，仅需2元。", "74", "161", "06", "01" }, { "正版验证，仅需4元。", "74", "161", "07", "01" }, { "战斗复活，仅需2元。", "74", "161", "08", "01" } };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 907 */     this.uc_number = new int[] { 40, 20, 40, 20, 20, 20, 40, 20 };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     this.showLine = 5;
/*     */     this.sendSms = -1;
/*     */     this.sel[1] = (byte)(((this.menu[this.menu_state]).length > 1) ? 1 : 0);
/*     */     this.sel[0] = (byte)(((this.menu[this.menu_state]).length > 1) ? 1 : 0);
...
/*     */         this.gr.rmsSms[this.smsCount[this.smsType][2]] = (byte)(this.gr.rmsSms[this.smsCount[this.smsType][2]] + 1);
/*     */         if ((byte)(this.gr.rmsSms[this.smsCount[this.smsType][2]] + 1) != this.smsCount[this.smsType][1]) {
/*     */           this.sendSms = 0;
...
/*     */       int j = this.sel[1];
/*     */       while (j < this.sel[1] + this.showLine && j < (this.menu[this.menu_state]).length) {
/*     */         Ui.i().drawString(this.menuTxt[this.menu[this.menu_state][j]][0], x + (w >> 1), y + 4 + (j - this.sel[1]) * (fh - 1), 17, (this.sel[0] == j) ? 0 : 3, 0);
/*     */         j++;
/*     */       } 
...
/*     */           i = this.gr.rmsSms[i];
/*     */         } 
/*     */         smsTip = getSmsTip(i, this.smsCount[this.smsType][1] - i);
...
/*     */             for (byte i = 0; i < this.gr.myMon_length; i = (byte)(i + 1))
...
/*     */     } 
/*     */     byte i = 0;
/*     */     for (; i < this.gr.myMon_length; i = (byte)(i + 1)) {
...
/*     */     for (byte i = (byte)(this.gr.myMon_length - 1); i > -1; i = (byte)(i - 1)) {
/*     */       if ((this.gr.myMonsters[i]).monster[2] < 70)
/*     */         return true; 
/*     */     } 
/*     */     return false;
...
/* Location:              /home/kasm-user/Downloads/宠物王国5 彩虹 (BT版)_N73.jar!/main/SMSSender.class
